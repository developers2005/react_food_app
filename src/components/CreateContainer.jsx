...
import { getAllFoodItems, saveItem } from "../utils/firebasFunctions";
  ...
  return (
    <div className="w-full min-h-screen h-auto flex items-center justify-center">
      <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        ...
        <div className="w-full py-2 border-bottom border-gray-300 flex items-center gap-2">
          <MdFastfood className="text-cl text-gray-700" />
          <input
            type="text"
            required
            value={Title}
            placeholder="Title"
            className="w-full h-full text-lg bg-transparent font-semibold outline-none border-none placeholde-text-gray-400 text-textColor"
        ...
        <div className="group flex justify-center items-center flex-col border-2 border-dotted border-green-300 w-full h-255 md:h-420 cursor-pointer rounded-lg">
          {IsLoading ? (
            <Loader />
          ) : (
            <>
        ...
        <div className="flex items-center w-full ">
          <button
           ...
           outline-none bg-emerald-500 px-12 py-2 
