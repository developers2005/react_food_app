    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 px-16 bg-primary ">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <li className="text-base text-headingColor text-textColor hover:text-headingColor duration-100 transition-all ease-in-out">
              Home
            </li>
            <li className="text-base text-headingColor text-textColor hover:text-headingColor duration-100 transition-all ease-in-out">
              Menu
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "dweb5617@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
      ...
      <div className="flex md:hidden w-full h-full items-center justify-between">
        ...
        >
          ...
          -right-2 w-5 h-5 rounded-full bg-cartNumBg flex items-center justify-center"
            >
              <p className="text-xs text-white font-semibold">
                {cartItems.length}
              </p>
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col  ">
                <li
                  className="text-base text-headingColor text-textColor hover:bg-slate-100 px-4 py-2 hover:text-headingColor duration-100 transition-all ease-in-out"
                  onClick={() => setisMenu(false)}
                >
                  Home
                </li>
