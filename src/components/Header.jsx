          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col  ">
                <li className="text-base text-headingColor text-textColor hover:bg-slate-100 px-4 py-2 hover:text-headingColor duration-100 transition-all ease-in-out" onClick={()=>setisMenu(false)}>
                  Home
                </li>
                <li className="text-base text-headingColor text-textColor hover:bg-slate-100 px-4 py-2 hover:text-headingColor duration-100 transition-all ease-in-out" onClick={()=>setisMenu(false)}>
                  Menu
